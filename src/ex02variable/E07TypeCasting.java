...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		*/
		byte b1 = 65;
		short s1;
		//byte가 short보다 작은자료형 이므로 자동형변환 된다.
		s1 = b1;
		System.out.printf("b1은 %d, s1은 %d%n", b1, s1);
		
		/*
		아래 코드는 자동형변환이 아니다.
		CPU는 int보다 작은 자료를 연산할때는 int로 간주하여 진행하고
		결과도 int로 반환한다.
		...
		*/
		...
		/*
		소수점 아래부분이 버려지므로 데이터 손실이 없는 경우이다.
		...
		*/
		...
		/* 서식문자 사용시 %.2f는 정부수는 모두 출력하고, 
		소수 이하는 2자리까지만 표현한다. */
		
		/*
		문자는 메모리에 저장시 아스키코드로 저장되므로 int형 과의 연산을 진행한 후
