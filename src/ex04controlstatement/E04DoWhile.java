...
/*
do~while문 : 반드시 한번은 실행해야 할 경우 사용하는 반복문으로 조건검사없이
무조건 한번은 실행된다.
형식]
	반복을 위한 변수;
	do{
...
public class E04DoWhile {
	...
	public static void main(String[] args) throws IOException{
		...
		*/
		...
		/*
		시나리오] 1부터 1000까지의 정수 중 4의배수 이거나 7의배수인 합을
		...
		*/
		...
		do~while문으로 구현해야한다.
		*/
		//사용자로부터 입력을 받기 위해 Scanner인스턴스 생성
		...
		do {
			...
			99점 혹은 91점을 10으로 나눈 몫이 9라는 것을 통해 구간을 대체하는
			산술결과를 얻을 수 있다.
			*/
