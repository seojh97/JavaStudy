	...
	*/
	public static void main(String[] args) {
		...
		*/
		myWantSum(s, e);
		/*
		main() 메서드에서 호출 시 전달한 2개의 정수를 매개변수가 순서대로 값을 받게된다.
	...
	static void myWantSum(int startNum, int endNum) {
		/*
		1에서 10까지의 합을 구하는 수열 프로그램을 시작값과 종료값만 변수로
		변경하여 원하는 구간의 합을 구하는 프로그램으로 커스터마이징하여 재정의 하였다.
		*/
		int sum = 0;
