package ex06array;
/*
배열 : 순차적인 메모리의 공간이 할당되는 형태로써 하나가 아니라 여러개의 변수가 
필요한 경우 사용한다.
...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		numArr[2] = 30;
		//인덱스로 접근하여 값을 출력한다.
		System.out.println("numArr의 0번반의 값:"+ numArr[0]);
		System.out.println("numArr의 1번반의 값:"+ numArr[1]);
		System.out.println("numArr의 2번반의 값:"+ numArr[2]);
		//정수형 배열이 Heap영역에 생성된 후 반환된 주소값이 출력된다.
		System.out.println("배열명(numArr)="+ numArr);
		System.out.println("============================");
		
		/*
		배열의 선언 및 초기화 : 배열은 여러개의 변수를 사용하기 위해 선언하므로
		...
		*/
		...
		/*
		배열의 선언과 동시에 초기화하는 경우 자바 컴파일러는 초기값의 갯수를 통해
		배열의 크기를 결정할 수 있다.
