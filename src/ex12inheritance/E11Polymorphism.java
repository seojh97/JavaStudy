...
/*
다형성(Polymorphism) : 하나의 인스턴스(객체)를 여러 타입의 참조변수를 통해
참조할때 참조변수의 타입에 따라 다양한 형태의 인스턴스를 이용할 수 있는 특성을
말한다.
...
class Child extends Parent{
	...
	/*
	메서드명은 동일하지만 매개변수가 다르므로 오버로딩으로 정의된 메서드이다.
	따라서 자식에서 확장한 멤버가 된다.
	*/
...
public class E11Polymorphism {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//부모타입으로 자식 인스턴스에 접근할 수 없으므로 에러발생
		...
		소괄호를 하나 더 추가해서 parent2를 자식타입으로 형변환 후 멤버면수에
		접근해야 한다.
		*/
