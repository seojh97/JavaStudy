...
class MyClass{
	...
	*/
	...
	/*
	MyClass 인스턴스간의 내용 비교를 위해 equals()를 오버라이딩 하여 재정의한다.
	인스턴스가 가진 멤버변수의 값에 대한 비교를 통해 동일여부를 판단한다.
	equals()메서드의 매개변수 타입은 모드 인스턴스를 대상으로 하므로
	Object형으로 정의되어있다.
	*/
	@Override
		...
		if(obj instanceof MyClass) {
			...
			*/
			...
			if(mc.data == this.data) {
				...
				//다르면 false를 반환함
				System.out.println("MyClass-엠버다름");
				return false;
			}
		}
		else {
...
public class E04Object3Equals {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		print()를 통해 출력하면 자동으로 toString()을 호출하므로 아래
		출력결과는 동일하다.
		*/
