...
public class Ex03ArrayList1 {
	...
	public static void main(String[] args) {
		...
		ArrayList와 나머지 컬렉션들은 데이터를 저장하는 내부적이 자료구조만
		다를뿐 사용법은 100% 동일하다.
		*/
		...
		*/
		...
		/*
		저장된 객체수(리스트의 크기) : size() 컬렉션에 저장된 인스턴스의
		갯수를 반환한다.
		...
		*/
		...
		/*
		방법2 : 확장 for문의 경우 인덱스없이 전체 원소를 반복해주므로 좀더
		간단한 표현이 가능하다.
		따라서 가장 많이 사용된다.
		*/
		System.out.println("\n[확장for문 사용]");
		...
		/*
		방법3 : Iterator 사용
		1. 컬렉션에 저장된 내용을 Iterator 객체에게 알려주기 위해 인스턴스를
		생성한다.
