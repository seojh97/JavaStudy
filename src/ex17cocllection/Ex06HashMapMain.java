...
public class Ex06HashMapMain {
	...
	public static void main(String[] args) {
		...
		*/
		...
		int number = 20;
		//map.put("age", number);
		//정수는 아래와 같이 문자열로 변경한 후 저장하 수 있다.
		...
		*/
		...
		/*
		3.이터레이터를 사용 : 이터레이터를 통해 출력할때도 keySet()을 통해
		...
		*/
		...
		/*
		value만 얻어올때는 values() 메서듣를 통해 값을 추출할 수 있다.
		...
		*/
		...
		/*
		객체의 존재유무확인 : Map컬렉션은 Key와 Value가 있으므로 메서드도 
		2개로 나눠져있다.
		*/
