...
/*
인터페이스 정의 : 인터페이스에는 추상메서드만 정의할 수 있다.
구현부가 없는 메서드 이므로 기능을 가질 수 없고, 오직 오버라이딩의 목적으로만 
사용된다.
*/
interface ISchool1{
...
추상메서드를 포함한 클래스는 반드시 abstract로 선언하거나, 그렇지 않으면 
오버라이딩을 통해 부모 인터페이스의 추상메서드를 재정의해야한다.
이렇게 가려지게된다.
*/
