...
/*
3. 람다식으로 구현하기 : 객체지향 프로그래밍에서는 메서드를 선언하기 위해 반드시
클래스를 정의해야한다.
이러한 불편함 때문에 함수형 프로그래밍(Functional Programming)의 장점이
	...
	public static void main(String[] args) {
		...
		*/
		ISchool3 sch1 = (String str) ->{
			System.out.println(str +"을 드립어 써보네요..!!");
		};
